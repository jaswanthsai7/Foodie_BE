...
public class MessageConfiguration {
    private static final String exchangeName = "userorderexchange";
    private static final String registerQueue = "userorderqueue";
    ...
    Binding bindingUser(DirectExchange exchange, Queue registerQueue) {
        return BindingBuilder.bind(registerQueue()).to(exchange).with("userorderkey");
    }
}
